      ...
      <main className="w-full max-w-[800px] p-4 md:p-6 mt-16 px-6 mx-auto animate-page-enter">
        ...
        <div className="flex flex-col gap-6 mt-8">
          <div className="flex items-center gap-3">
            ...
            <button className="group flex-1 max-w-[150px] py-2.5 bg-zinc-900/50 border border-zinc-800 rounded-[10px] font-medium text-zinc-400 text-[10px] transition-all duration-300 hover:border-zinc-600 hover:bg-zinc-800 hover:text-white active:scale-95 flex items-center justify-center gap-2" onClick={() => showToast("Preparando descarga del CV...", "info")}>
