    ...
    <div className="relative border-l border-zinc-800 ml-3 pl-8 py-2 space-y-10">
      {trayectoriaData.map((item) => (
        <div key={item.id} className="relative">
          <div className={`absolute -left-10 top-1.5 w-2.5 h-2.5 rounded-full ring-4 ring-zinc-950 ${item.active ? 'bg-brand-accent' : 'bg-zinc-700'}`}></div>
          <h3 className="text-white font-bold text-[15px]">{item.role}</h3>
          <p className={`${item.active ? 'text-brand-accent' : 'text-zinc-500'} text-[12px] font-medium mb-3`}>
 ...
 return (
    <main className="w-full max-w-[800px] mx-auto px-5 md:px-6 py-8 md:py-12 animate-page-enter">
      ...
      <section className="mb-10 w-full">
        ...
        <div className="space-y-2 mb-6 text-[11px] md:text-xs text-zinc-400 max-w-3xl font-normal leading-relaxed">
       ...
       <div className="flex flex-wrap items-center gap-2 w-full select-none">
                ...
                <a 
                  ...
                  className="group relative flex-1 min-w-[115px] max-w-[140px] py-2 md:py-2.5 bg-white/5 border border-white/10 rounded-[10px] font-semibold text-white text-[12.5px] md:text-[13px] overflow-hidden text-center active:scale-95 transition-all no-underline"
                >
                ...
                <button
                  ...
                  className="group relative flex-1 min-w-[115px] max-w-[140px] py-2 md:py-2.5 bg-white/5 border border-white/10 rounded-[10px] font-semibold text-white text-[12.5px] md:text-[13px] overflow-hidden text-center active:scale-95 transition-all cursor-pointer"
                >
                  <div className="absolute inset-0 bg-linear-to-r from-transparent via-brand-accent/20 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-1000"></div>
                ...
                <a
                  ...
                  className="group relative inline-flex items-center justify-center h-9 w-9 md:h-10 md:w-10 rounded-[10px] bg-white/5 border border-white/10 text-brand-muted hover:text-white transition-all active:scale-95 overflow-hidden shrink-0"
                >
                  <div className="absolute inset-0 bg-linear-to-r from-transparent via-brand-accent/20 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-1000"></div>
