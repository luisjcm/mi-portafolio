...
export function ToastProvider({ children }: { children: ReactNode }) {
  ...
  return (
    <ToastContext.Provider value={{ showToast }}>
      ...
      {toast && (
        <div className="fixed bottom-5 right-5 z-[200] flex items-center gap-3 px-4 py-3 rounded-xl border backdrop-blur-md bg-zinc-950/90 shadow-2xl transition-all duration-300 animate-page-enter
